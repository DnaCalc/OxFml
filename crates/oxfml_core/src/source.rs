...
impl FormulaSourceRecord {
    ...
    pub fn with_formula_channel_kind(mut self, formula_channel_kind: FormulaChannelKind) -> Self {
        self.formula_channel_kind = formula_channel_kind;
        self
    }

    pub fn with_stored_formula_text(mut self, stored_formula_text: impl Into<String>) -> Self {
        self.stored_formula_text = Some(stored_formula_text.into());
        self
    }
